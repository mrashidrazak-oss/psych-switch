...
import 'package:psychswitch/src/engine/specialty/geriatric.dart';
import 'package:psychswitch/src/engine/specialty/pediatric.dart';
import 'package:psychswitch/src/engine/specialty/pregnancy.dart';
import 'package:psychswitch/src/engine/specialty/types.dart';

export 'package:psychswitch/src/engine/specialty/geriatric.dart';
export 'package:psychswitch/src/engine/specialty/pediatric.dart';
export 'package:psychswitch/src/engine/specialty/pregnancy.dart';
export 'package:psychswitch/src/engine/specialty/types.dart';
